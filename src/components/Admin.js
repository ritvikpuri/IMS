              ...
              <div class="form-row">
                <div class="form-group col-md-2">
                  <ListGroup>
                    ...
                    <ListGroup.Item action onClick={() => this.handleClick('inventory')}>Inventory List</ListGroup.Item>
                    <br/>
                    <ListGroup.Item variant="info">Users</ListGroup.Item>
                    <ListGroup.Item action onClick={() => this.handleClick('users')}>User List</ListGroup.Item>
                  </ListGroup>
                </div>
                            ...
                            <tr className="TH" key={item.id}>
                              ...
                              {this.state.status[index] !== 'accepted' ?
                                  <td className="TH2" key={index}><Button className="btnn"
                                                                          onClick={() => this.handleReject(index)}>unavailable</Button>
                                  </td> : false}
                              {this.state.status[index] === 'accepted' ?
                                  <td className="TH2" key={index}><Button className="btnn"
                                                                          onClick={() => this.handleRejectAfterAccept(index)}>unavailable</Button>
                                  </td> : false}
                            </tr>
                        )
                      })
