    ...
    return (
     <div>
       <form onSubmit={this.addItem}>    
          ...
          <br/>
          <p className="L">quantity to add</p>
          <input type='text' value={this.state.qty} onChange={this.handleQtyChange} required/>
          <br/>
         <select id = "myList" value={this.state.type} onChange={this.handleTypeChange}>
          ...
          <button className="btn" type='submit' value='submit' data-test="submit" >submit</button>
          <br/>
        </form>    
      </div>
    )
