...
import './../App.css';
import {Jumbotron, Container, Nav, Navbar, NavDropdown, FormControl, Form, ListGroup,Table,Button} from 'react-bootstrap';
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group col-md-3">
                            <ListGroup>
                                ...
                                <ListGroup.Item action onClick={() => this.handleClick('active')}>New</ListGroup.Item>
                        ...
                        <div class="form-group col-md-9">
                            {this.state.current === 'history' ? <><h1 className="H">Request History</h1><Table striped
                                                                                                               bordered
                                                                                                               hover>
                                <thead>
                                <tr className="TH">
                                        ...
                                        return (
                                            <tr className="TH" key={item.id}>
                                                ...
                                                {this.state.status[index] !== 'accepted' ?
                                                    <td className="TH2" key={item.serialNumber}><Button className="btnn"
