...
<title>Your Request for ${request.itemName} has Timed Out</title>
</head>
					...
					<tr>
						<td align="center" valign="top" bgcolor="#FFB6C1"
							...
							<div style="font-size: 18px; color:blue;">
								<b>Your request for the following item has been timed out due to it not having been collected from the recpetion.</b>
							</div>
